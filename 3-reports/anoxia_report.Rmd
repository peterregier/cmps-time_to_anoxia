...
```{r optode_group_all, fig.height=4, fig.width=8}
tar_read(gg_optode_all)$grouped
```

```{r optode_group_subset, fig.height=4, fig.width=8}
tar_read(gg_optode)$grouped
```

```{r optode_indiv_all, fig.height=12, fig.width=8}
...
### Dissolved ions
```{r, ions, fig.height=10, fig.width=10}
tar_read(gg_ions)
```
